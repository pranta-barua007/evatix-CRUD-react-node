...
import {requestSignOut} from '../redux/user/user.actions';
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              {
                currentUser && currentUser.id ? (
                  <li>
                    <button 
                      className="font-medium text-gray-600 hover:text-red-900 px-5 py-3 flex items-center transition duration-150 ease-in-out"
...
const mapDispatchToProps = dispatch => {
  return {
      signOutStart: () => dispatch(requestSignOut()) 
  }
};
